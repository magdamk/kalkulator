...
public class Menu extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        jtxtDisplay.setBackground(new java.awt.Color(215, 247, 183));
        ...
        jBtn17.setBackground(new java.awt.Color(249, 157, 67));
        jBtn17.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jBtn17.setForeground(new java.awt.Color(0, 0, 0));
        jBtn17.setText("C");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jBtn17, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jBtn16, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jBtn18, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(24, 24, 24)
                .addComponent(jtxtDisplay, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(29, 29, 29)
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jBtn17, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    {//GEN-HEADEREND:event_jBtn1ActionPerformed
        if ((jtxtDisplay.getText().length() == 0 
                ||jtxtDisplay.getText().charAt(0) != '0')
                && (!error))
        {
    ...
    {//GEN-HEADEREND:event_jBtn3ActionPerformed
         if ((jtxtDisplay.getText().length() == 0 
                ||jtxtDisplay.getText().charAt(0) != '0')
                && (!error))
        {
    ...
    {//GEN-HEADEREND:event_jBtn4ActionPerformed
        if ((jtxtDisplay.getText().length() == 0 
                ||jtxtDisplay.getText().charAt(0) != '0')
                && (!error))
        {
    ...
    {//GEN-HEADEREND:event_jBtn5ActionPerformed
        if ((jtxtDisplay.getText().length() == 0 
                ||jtxtDisplay.getText().charAt(0) != '0')
                && (!error))
        {
    ...
    {//GEN-HEADEREND:event_jBtn6ActionPerformed
        if ((jtxtDisplay.getText().length() == 0 
                ||jtxtDisplay.getText().charAt(0) != '0')
                && (!error))
        {
    ...
    {//GEN-HEADEREND:event_jBtn7ActionPerformed
         if ((jtxtDisplay.getText().length() == 0 
                ||jtxtDisplay.getText().charAt(0) != '0')
                && (!error))
        {
    ...
    {//GEN-HEADEREND:event_jBtn8ActionPerformed
         if ((jtxtDisplay.getText().length() == 0 
                ||jtxtDisplay.getText().charAt(0) != '0')
                && (!error))
        {
    ...
    {//GEN-HEADEREND:event_jBtn9ActionPerformed
         if ((jtxtDisplay.getText().length() == 0 
                ||jtxtDisplay.getText().charAt(0) != '0')
                && (!error))
        {
    ...
    {//GEN-HEADEREND:event_jBtn10ActionPerformed
    ...
    {//GEN-HEADEREND:event_jBtn11ActionPerformed
    ...
    {//GEN-HEADEREND:event_jBtn12ActionPerformed
        firstNum = Double.parseDouble(jtxtDisplay.getText());
        jtxtDisplay.setText("");
        operations = "-";
    ...
    {//GEN-HEADEREND:event_jBtn13ActionPerformed
        firstNum = Double.parseDouble(jtxtDisplay.getText());
        jtxtDisplay.setText("");
        operations = "*";
    ...
    {//GEN-HEADEREND:event_jBtn14ActionPerformed
        firstNum = Double.parseDouble(jtxtDisplay.getText());
        jtxtDisplay.setText("");
        operations = "/";
    ...
    {//GEN-HEADEREND:event_jBtn16ActionPerformed
        System.out.println(firstNum + ", " + secondNum + ", " + result);
        if (error || jtxtDisplay.getText().length() == 0)
        {
            error = false;
            jtxtDisplay.setText("");
          //  firstNum = 0;
    ...
    {//GEN-HEADEREND:event_jBtn15ActionPerformed
        String display = jtxtDisplay.getText();
        if (display.length() > 0)
        {
        double oposite = (-1)*Double.parseDouble(String.valueOf(display));
        jtxtDisplay.setText(String.valueOf(oposite));
        }
    ...
    {//GEN-HEADEREND:event_jBtn18ActionPerformed
